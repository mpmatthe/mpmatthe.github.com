(() => {
  ...
  function removeAllDates() {
    console.log("removing all article dates");
    for (var a = document.getElementsByClassName("article-date"); a.length > 0; )
      a[0].parentNode.removeChild(a[0]);
  }
  function removeAllArticleLinks() {
    var b, a, c;
    console.log("removing all article links"), b = document.getElementsByClassName("article-title");
    for (a = 0; a < b.length; a++)
      b[a].getElementsByTagName("a")[0].removeAttribute("href");
    c = document.getElementsByClassName("summary-link");
    for (a = 0; a < c.length; a++)
      c[a].removeAttribute("href");
  }
  function prepareSite() {
    removeAllDates(), removeAllArticleLinks();
  }
